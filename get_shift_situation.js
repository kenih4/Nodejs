...
babel-node get_shift_situation.js
node get_shift_situation.js
...
/*
//		var cmd = "text2clipbord.exe \"test.txt\"";
			var cmd = "text2clipbord_UTF-8.exe \"C:\\me\\node\\test.txt\"";
//			var cmd = "text2clipbord_UTF-8.exe " + file;			
//		var cmd = "notepad \"C:\\me\\node\\test.txt\"";
	//	var cmd = "\"C:\\Program Files (x86)\\WinSCP\\WinSCP.exe\" /console /script=getscript.txt /parameter \"" + path +  "\" \"/home/xfel/xfelopr/bin/table/sacla_watch_data/sacla_watch_data.txt\"";
			...
			await childProcess.execSync(cmd, (error, stdout, stderr) => {
				if(error) {
				console.log(stderr);
				return;
				}else {
